...
### Phase 1: Database & Types (2 days)
- [ ] Create `TagDefinition` model in schema
- [ ] Create `PositionTag` model in schema
- [ ] Add `TagCategory` enum
- [ ] Run `pnpm prisma db push`
- [ ] Create `src/types/tags.ts` with TypeScript interfaces
- [ ] Create seed script for default tags

### Phase 2: Tag Management API (2 days)
- [ ] Create `/api/tags/route.ts` (GET, POST)
- [ ] Create `/api/tags/[id]/route.ts` (PATCH, DELETE)
- [ ] Create `/api/tags/restore/[id]/route.ts`
- [ ] Create `/api/tags/reorder/route.ts`
- [ ] Add authorization checks (userId filtering)

### Phase 3: Position Tagging API (2 days)
- [ ] Create `/api/positions/[key]/tags/route.ts`
- [ ] Create `/api/positions/bulk-tag/route.ts`
- [ ] Create position key generation utility
- [ ] Handle position key encoding/decoding (URL-safe)

### Phase 4: Settings Page UI (3 days)
- [ ] Create `/settings` page layout
- [ ] Create `/settings/tags` page
- [ ] Build tag category tabs component
- [ ] Build tag list with drag-and-drop
- [ ] Build tag create/edit dialog
- [ ] Build color picker component
- [ ] Build archive/restore functionality

### Phase 5: Journal Integration (3 days)
- [ ] Add tag column to journal table
- [ ] Add tag filter to global-filter-bar
- [ ] Update filter context with tag state
- [ ] Build tag filter dropdown component
- [ ] Update position detail sheet with tags
- [ ] Build quick-add tag buttons
- [ ] Build inline tag creation

### Phase 6: Tag Analytics (2 days)
- [ ] Create `/api/tags/analytics/route.ts`
- [ ] Build tag performance report section
- [ ] Build mistake cost analysis chart
- [ ] Build emotion correlation table
- [ ] Add dashboard widgets

### Phase 7: Bulk Operations (1 day)
- [ ] Add multi-select mode to journal
- [ ] Build bulk tag assignment dialog
- [ ] Implement bulk tag/untag endpoints
