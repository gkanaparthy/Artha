    ...
    return (
        <div className={cn("min-h-screen bg-[#0A110D] flex flex-col", inter.className)}>
                ...
                <div className="container mx-auto px-4 h-16 flex items-center justify-between max-w-6xl">
                    <div className="flex items-center gap-2 sm:gap-3">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 relative flex items-center justify-center">
                            <Image src="/logo-dark.png" alt="Artha Logo" fill className="object-contain" />
                        </div>
                        <span className={cn("text-white text-xl sm:text-2xl font-bold tracking-tight", playfair.className)}>
                            Artha
                        </span>
                    </div>
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        <Link href="#product" className="text-white/70 hover:text-white text-sm font-medium transition-colors">
                            Product
                        </Link>
                        ...
                        <Link href="/login" className="text-white font-medium text-sm hover:opacity-80 transition-opacity">
                            Log in
                        </Link>
                        <Link href="/login">
                        ...
                        >
                            <nav className="container mx-auto px-4 py-4 flex flex-col gap-3 max-w-6xl">
                                ...
                                <Link
                                    href="/login"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className="text-white font-medium text-sm hover:opacity-80 transition-opacity py-2"
                                >
                                    Log in
                                </Link>
            ...
            <main className="flex-1 pb-20 md:pb-0">
                    ...
                    <div className="container mx-auto px-4 max-w-6xl relative z-10">
                        <div className="flex flex-col items-center text-center max-w-3xl mx-auto space-y-6 sm:space-y-8">
                            ...
                            >
                                ...
                                >
                                    <div className="bg-[#11211A] rounded-full px-4 py-2 shadow-lg text-xs font-bold text-white whitespace-nowrap">
                                        FIFO P&L Engine
                                    </div>
                ...
                {/* Problem Section */}
                <section className="py-14 sm:py-16 bg-[#11211A] border-b border-white/5">
                    <div className="container mx-auto px-4 max-w-4xl text-center">
                        <h2 className={cn("text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-5", playfair.className)}>
                ...
                {/* Features Section */}
                <section id="product" className="py-16 sm:py-20 md:py-24 bg-[#11211A] relative">
                    <div className="container mx-auto px-4 max-w-6xl">
                        <div className="text-center mb-12 sm:mb-16">
                            <h2 className={cn("text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4", playfair.className)}>
...
function FeatureCard({ icon: Icon, title, description, accentColor }: { icon: LucideIcon, title: string, description: string, accentColor: string }) {
    return (
        <div className={cn(
            ...
            <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center mb-4 sm:mb-6 text-white">
...
function StatsPill({ value, label }: { value: string; label: string }) {
    return (
        <div className="rounded-2xl border border-white/10 bg-[#11211A] p-6 text-center shadow-sm">
...
function FounderStorySection() {
    return (
        <section className="py-16 sm:py-20 bg-[#11211A]">
    ...
    return (
        <section className="py-16 sm:py-20 bg-[#0A110D]">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="rounded-3xl border border-white/10 bg-[#11211A] p-6 sm:p-8 text-center">
        ...
        <section className="py-16 sm:py-20 bg-[#11211A]">
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="rounded-3xl border border-white/10 bg-[#4ADE80]/10 border border-[#4ADE80]/20 p-6">
                        <div className="text-sm font-semibold text-white/60 mb-3">Week 8</div>
