                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-[#0A110D]">
                                ...
                                <th className="p-6 text-sm font-bold text-white uppercase tracking-wider text-center bg-white/5">
                                ...
                                <tr key={idx} className="hover:bg-[#0A110D]/80 transition-colors">
                                    ...
                                    <td className="p-6 text-center">
                                        {typeof feature.spreadsheet === "boolean" ? (
                                            ...
                                            <span className="text-sm text-white/60 font-medium">{feature.spreadsheet}</span>
                                        )}
                                    </td>
                                    <td className="p-6 text-center">
                                        {typeof feature.other === "boolean" ? (
                                            ...
                                            <span className="text-sm text-white/60 font-medium">{feature.other}</span>
                                        )}
                                    </td>
