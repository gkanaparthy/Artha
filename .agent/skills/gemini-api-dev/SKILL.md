---
name: gemini-api-dev
description: Instructions and best practices for developing with the Gemini API, including multimodal understanding, function calling, structured output, and context caching.
---
